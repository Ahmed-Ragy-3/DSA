...
/**
 * InsertionSort is a simple, comparison-based sorting algorithm that builds the
 * final sorted array
 * one element at a time by repeatedly picking the next element and inserting it
 * into its correct
 * position within the sorted portion of the array.
 * <p>
 * The algorithm is efficient for small datasets and partially sorted arrays but
 * becomes slow on
...
public class InsertionSort {
    ...
    /**
     * Sorts the input array using the Insertion Sort algorithm with a custom
     * comparator.
     *
     * @param arr        Array to sort.
    ...
    public static <T> void sort(T[] arr, Comparator<? super T> comparator) {
        for (int i = 1; i < arr.length; i++) {
            ...
            // Shift elements that are greater than key to one position ahead of their
            // current position
