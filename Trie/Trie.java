...
public class Trie implements ITrie {
    ...
    * Case 5 : bear - bean (delete bean) ----> remove key (n) in the hashmap of
    * letter(a)
    */
   @Override
   ...
   public List<String> getWordsWithPrefix(String prefix) {
      ...
      for (char c : prefix.toCharArray()) {
         if (!tempNode.letters.containsKey(c))
   ...
   private int countWordsWithPrefix(TrieNode tempNode, int count) {
      if (tempNode.wordEnd)
         count++;
   ...
   public static void main(String[] args) {
      ...
      compu.insert("algorithm", "binary", "cache", "data", "encryption",
            ...
            "back-end", "class", "distributed system", "encryption key", "front-end", "garbage collection",
            "hypervisor",
            "index", "JVM", "Kubernetes", "lambda function", "metadata", "normalization", "OOP", "polymorphism",
            "relational database", "SQL", "test case", "Unicode", "virtualization", "web socket", "XML schema",
      ...
      Trie big = ITrie.combine(t1, t2, t3, compu);
      // big.printTrieWords();
      big.suggest("encry");
